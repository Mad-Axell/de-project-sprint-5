...
class DeliveryOriginRepository:
    ...
    def load_deliveries(self, sort_field: str, sort_direction: str, offset: int = 0, limit: int = 1000000) -> None:
        ...
        api_str =   "https://d5d04q7d963eapoepsqr.apigw.yandexcloud.net/deliveries?sort_field=%s&sort_direction=%s&limit=%d&offset=%d" % (sort_field, sort_direction, limit, offset)
...
class REST_DeliveryLoader:
    ...
    def __init__(self, collection_loader: DeliveryOriginRepository, pg_dest: PgConnect, pg_saver: DeliveryDestRepository, logger: Logger) -> None:
